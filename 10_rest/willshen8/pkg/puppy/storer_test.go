...
func (s *StorerSuite) TestCreatePuppyWithNoValue() {
	m := assert.New(s.T())
	NoValuePuppy := Puppy{ID: 88, Breed: "Spaniel", Color: "Black", Value: "$$$"}
