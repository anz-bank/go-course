...
import (
	...
	"github.com/anz-bank/go-course/10_rest/kasunfdo/pkg/puppy"
	"github.com/anz-bank/go-course/10_rest/kasunfdo/pkg/puppy/store"
...
func parseArgs(args []string) (Config, error) {
	...
	return Config{*dataFile, *port, *storeType}, err
}
...
func initPuppyServer(config Config) error {
	...
	apiHandler := puppy.NewAPIHandler(puppyStore)
